...
class mp_dzp_user implements platform_interface {
    ...
    public function action() {
    	...
    	if ($_POST) {
    		...
    		return ecjia_front::$controller->showmessage('资料提交成功，请等待发放奖品,可以继续去参加大转盘赢得丰厚礼品哦', ecjia::MSGTYPE_JSON | ecjia::MSGSTAT_SUCCESS,array('pjaxurl' => RC_Uri::url('platform/plugin/show', array('handle' => 'mp_dzp/init', 'openid' => $openid, 'uuid' => $uuid))));
    	}       
	}
}
